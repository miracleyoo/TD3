...
def train(policy='TD3', seed=0, start_timesteps=25e3, eval_freq=5e3, max_timesteps=1e5,
          ...
          delayed_env=False, env_name='InvertedPendulum-v2', parent_response_rate=0.04, train_parent=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_parent", action="store_true", help="Train parent when true and child when false")
