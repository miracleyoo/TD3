...
def train(policy='TD3', seed=0, start_timesteps=25e3, eval_freq=5e3, max_timesteps=1e5,
          ...
          save_model=False, jit_duration=0.02, response_rate=0.04,
    ...
    arguments = ["reflex_fixed", policy_name, env_name, seed, jit_duration, g_ratio, response_rate, catastrophe_frequency,
                 delayed_env, parent_response_rate, True, 'best']
